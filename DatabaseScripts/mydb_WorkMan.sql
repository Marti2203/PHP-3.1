...
CREATE TABLE `WorkMan` (
  ...
  `PaymentPerHour` decimal(8,3) DEFAULT NULL,
  `User_ID` int(11) NOT NULL,
  PRIMARY KEY (`ID`,`User_ID`),
  KEY `fk_WorkMan_User1_idx` (`User_ID`),
  CONSTRAINT `fk_WorkMan_User1` FOREIGN KEY (`User_ID`) REFERENCES `User` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `WorkMan` VALUES (1,'Artist',2121.110,15),(2,'Programmer',12.220,5);
